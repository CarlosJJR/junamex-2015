...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private void addTab(final int position, CharSequence title, View tabView) {
        TextViewFont textView = (TextViewFont) tabView.findViewById(R.id.tab_title);
        if (textView != null) {
    ...
    private void updateTabStyles() {
        for (int i = 0; i < tabCount; i++) {
            ...
            TextViewFont tab_title = (TextViewFont) v.findViewById(R.id.tab_title);
...
//                tab_title.setTypeface(tabTypeface, pager.getCurrentItem() == i ? tabTypefaceSelectedStyle : tabTypefaceStyle);
    ...
    private void notSelected(View tab) {
        if (tab != null) {
            TextViewFont title = (TextViewFont) tab.findViewById(R.id.tab_title);
            if (title != null) {
